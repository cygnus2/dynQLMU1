...
void diag_LAPACK(std::vector<double>& matrix, std::vector<double>& eval, std::vector<double>& evec){
    unsigned int i,j;
...
void diag_LAPACK_RRR(std::vector<double>& matrix, std::vector<double>& eval, std::vector<double>& evec){
